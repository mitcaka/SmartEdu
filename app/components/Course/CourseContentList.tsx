  ...
  return (
    <div className={`mt-[15px] w-full ${!props.isDemo && 'ml-[-30px] min-h-screen sticky top-24 left-0 z-30'}`}>
      {videoSections.map((section: string, sectionIndex: number) => {
        ...
        return (
          <div className={`${!props.isDemo && 'border-b light:border-[#0000001c] dark:border-[#ffffff8e] pb-2'}`} key={section}>
            <div className="w-full flex">
              {/* Render video section */}
              <div className="w-full flex justify-between items-center"
              >
                <h2 className="text-[22px] light:text-black dark:text-white">{section}</h2>
                <button
                  className="mr-4 cursor-pointer light:text-black dark:text-white"
            ...
            <h5 className="light:text-black dark:text-white">
              ...
              <div className="w-full">
                {sectionVideos.map((item: any, index: number) => {
                  ...
                  return (
                    <div
                      className={`w-full ${
                        videoIndex === props.activeVideo ? "bg-blue-100 dark:bg-slate-800" : ""
                    ...
                    >
                      <div className="flex items-start">
                        ...
                        <h1 className="text-[18px] inline-block break-words light:text-black dark:text-white">
                          {item.title}
                        </h1>
                      </div>
                      <h5 className="pl-8 light:text-black dark:text-white">
