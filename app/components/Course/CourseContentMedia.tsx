  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      socketId.emit("notification", {
        title: `Câu hỏi mới`,
        message: `Bạn có câu hỏi mới trong khóa học ${data[activeVideo].title}`,
        userId: user._id,
      });
    }
    if (answerSuccess) {
      ...
      if (user.role !== "admin") {
        socketId.emit("notification", {
          ...
          message: `Bạn nhận được câu trả lời trong khóa học ${data[activeVideo].title}`,
          userId: user._id,
        });
      }
    }
                ...
                <div className="flex w-full">
                  ...
                  <div className="w-full">
                    <h5 className="pl-3 text-[20px] font-[500] dark:text-white text-black ">
                      Viết đánh giá <span className="text-red-500">*</span>
                    </h5>
